      ...
      <div class="container">
        ...
        <div class="row">
           ...
           <?php
            ...
            $ambl = $kn->query("SELECT * FROM tb_ekstra_diikuti LEFT JOIN tb_user ON tb_ekstra_diikuti.id_user=tb_user.id_user LEFT JOIN tb_kelas ON tb_ekstra_diikuti.id_user = tb_kelas.id_user WHERE tb_ekstra_diikuti.id_user='$id' "); 
            ?>
          ...
          <?php if ($ambl->num_rows > 0) { ?>
            ...
            <div class="card-body">
              ...
              <hr class="my-4">
              <p style="color: #FD6300;" class="card-text fw-bold"><?php echo $perekstra['nama_lengkap']; ?></p>
              <p style="color: #FD6300;" class="card-text fw-bold"><?php echo $perekstra['kelas']; ?></p>
              <a  href="absensi.php?id=<?php echo $perekstra['id_ekstra']; ?>" class="btn btn-primary bg-color-absensi">Absensi</a>
            </div>
          </div>
        </div>
        <?php } ?>
