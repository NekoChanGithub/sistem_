...
$semuadata=array();
 ...
 $ambl = $kn->query("SELECT tb_user.nama_lengkap, tb_user.id_user, max(tb_absensi.keterangan), max(tb_absensi.waktu_absen), max(tb_kelas.kelas),max(tb_kelas.kelas) as kelas FROM tb_absensi 
...
<body>
  <div class="container">
    <div class="heading">
      <h3>Laporan Absensi Ekstrakurikuler <?php echo $ekstra ?></h3>
