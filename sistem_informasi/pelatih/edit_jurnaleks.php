...
<form class="offset-md-1" method="post" enctype="multipart/form-data">
  ...
  <div class="col-md-10 mb-3">
       ...
       <?php
        ...
        <textarea class="form-control" name="judul" id="floatingTextarea"><?php echo $pch['judul_jurnal'] ?></textarea>
        </div>

        <div class="form-floating col-md-10 mb-3">
        <label>Isi Jurnal</label>
        <textarea class="form-control" name="isi" id="floatingTextarea"><?php echo $pch['isi_jurnal'] ?></textarea>
        </div>
