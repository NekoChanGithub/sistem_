...
$ambl = $kn->query("SELECT tb_user.nama_lengkap, tb_user.id_user, max(tb_absensi.keterangan), max(tb_absensi.waktu_absen), max(tb_kelas.kelas) as kelas FROM tb_absensi 
...
<h2 class="h3 mb-5 text-gray-800">Laporan Absensi Ekstrakurikuler <?php echo $tgl_mulai ?> S/D <?php echo $tgl_selesai ?></h2>
 ...
 <form method="post">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    <button class="btn btn-primary" name="submit">Lihat Laporan</button>
                </div>
            </div>
        </div>
    </div>
